...
function GeoXml(myvar, map, url, opts) {
  ...
  this.style = {width:2,opacity:1,fillopacity:1};
  this.style.color = this.opts.color;// || this.randomColor();
  this.style.fillcolor = this.opts.fillcolor;// || this.randomColor();
...
GeoXml.prototype.handleGeomark = function (mark, idx, trans) {
	...
	fillColor = this.style.fillcolor || this.randomColor();
	color = this.style.color || this.randomColor();
	//alert("--->"+fillColor+" "+color);
	fill = 1;
	outline = 1;
...
GeoXml.prototype.handlePlacemark = function (mark, idx, depth, fullstyle) {
	...
	if(typeof fillcolor == "undefined"){ fillcolor = this.style.fillcolor || this.randomColor(); }
	if(typeof name == "undefined" ){ name=that.unnamedarea; }
	if(typeof fillOpacity == "undefined") { fillOpacity = this.style.fillOpacity ;}
	//alert("===>"+fillOpacity);
 	if (!!that.opts.createpolygon) {
